...
proc create_root_design { parentCell } {
  ...
  # Create instance: swerv_wrapper_verilog, and set properties
  set block_name swerv_wrapper_verilog
  set block_cell_name swerv_wrapper_verilog
  if { [catch {set swerv_wrapper_verilog [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $swerv_wrapper_verilog eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   }
  ...
  connect_bd_net -net clk_0_1 [get_bd_ports clk_0] [get_bd_pins bootrom_wrapper_0/i_clk] [get_bd_pins gpio_wrapper_0/wb_clk_i] [get_bd_pins intcon_wrapper_bd_0/clk_i_wrapper] [get_bd_pins swerv_wrapper_verilog/clk] [get_bd_pins syscon_wrapper_0/i_clk]
  connect_bd_net -net dmi_hard_reset_0_1 [get_bd_ports dmi_hard_reset_0] [get_bd_pins swerv_wrapper_verilog/dmi_hard_reset]
  connect_bd_net -net dmi_reg_addr_0_1 [get_bd_ports dmi_reg_addr_0] [get_bd_pins swerv_wrapper_verilog/dmi_reg_addr]
  connect_bd_net -net dmi_reg_en_0_1 [get_bd_ports dmi_reg_en_0] [get_bd_pins swerv_wrapper_verilog/dmi_reg_en]
  connect_bd_net -net dmi_reg_wdata_0_1 [get_bd_ports dmi_reg_wdata_0] [get_bd_pins swerv_wrapper_verilog/dmi_reg_wdata]
  connect_bd_net -net dmi_reg_wr_en_0_1 [get_bd_ports dmi_reg_wr_en_0] [get_bd_pins swerv_wrapper_verilog/dmi_reg_wr_en]
  ...
  connect_bd_net -net intcon_wrapper_bd_0_o_ifu_arready [get_bd_pins intcon_wrapper_bd_0/o_ifu_arready] [get_bd_pins swerv_wrapper_verilog/ifu_axi_arready]
  connect_bd_net -net intcon_wrapper_bd_0_o_ifu_rdata [get_bd_pins intcon_wrapper_bd_0/o_ifu_rdata] [get_bd_pins swerv_wrapper_verilog/ifu_axi_rdata]
  connect_bd_net -net intcon_wrapper_bd_0_o_ifu_rid [get_bd_pins intcon_wrapper_bd_0/o_ifu_rid] [get_bd_pins swerv_wrapper_verilog/ifu_axi_rid]
  connect_bd_net -net intcon_wrapper_bd_0_o_ifu_rlast [get_bd_pins intcon_wrapper_bd_0/o_ifu_rlast] [get_bd_pins swerv_wrapper_verilog/ifu_axi_rlast]
  connect_bd_net -net intcon_wrapper_bd_0_o_ifu_rresp [get_bd_pins intcon_wrapper_bd_0/o_ifu_rresp] [get_bd_pins swerv_wrapper_verilog/ifu_axi_rresp]
  connect_bd_net -net intcon_wrapper_bd_0_o_ifu_rvalid [get_bd_pins intcon_wrapper_bd_0/o_ifu_rvalid] [get_bd_pins swerv_wrapper_verilog/ifu_axi_rvalid]
  connect_bd_net -net intcon_wrapper_bd_0_o_lsu_arready [get_bd_pins intcon_wrapper_bd_0/o_lsu_arready] [get_bd_pins swerv_wrapper_verilog/lsu_axi_arready]
  connect_bd_net -net intcon_wrapper_bd_0_o_lsu_awready [get_bd_pins intcon_wrapper_bd_0/o_lsu_awready] [get_bd_pins swerv_wrapper_verilog/lsu_axi_awready]
  connect_bd_net -net intcon_wrapper_bd_0_o_lsu_bid [get_bd_pins intcon_wrapper_bd_0/o_lsu_bid] [get_bd_pins swerv_wrapper_verilog/lsu_axi_bid]
  connect_bd_net -net intcon_wrapper_bd_0_o_lsu_bresp [get_bd_pins intcon_wrapper_bd_0/o_lsu_bresp] [get_bd_pins swerv_wrapper_verilog/lsu_axi_bresp]
  connect_bd_net -net intcon_wrapper_bd_0_o_lsu_bvalid [get_bd_pins intcon_wrapper_bd_0/o_lsu_bvalid] [get_bd_pins swerv_wrapper_verilog/lsu_axi_bvalid]
  connect_bd_net -net intcon_wrapper_bd_0_o_lsu_rdata [get_bd_pins intcon_wrapper_bd_0/o_lsu_rdata] [get_bd_pins swerv_wrapper_verilog/lsu_axi_rdata]
  connect_bd_net -net intcon_wrapper_bd_0_o_lsu_rid [get_bd_pins intcon_wrapper_bd_0/o_lsu_rid] [get_bd_pins swerv_wrapper_verilog/lsu_axi_rid]
  connect_bd_net -net intcon_wrapper_bd_0_o_lsu_rlast [get_bd_pins intcon_wrapper_bd_0/o_lsu_rlast] [get_bd_pins swerv_wrapper_verilog/lsu_axi_rlast]
  connect_bd_net -net intcon_wrapper_bd_0_o_lsu_rresp [get_bd_pins intcon_wrapper_bd_0/o_lsu_rresp] [get_bd_pins swerv_wrapper_verilog/lsu_axi_rresp]
  connect_bd_net -net intcon_wrapper_bd_0_o_lsu_rvalid [get_bd_pins intcon_wrapper_bd_0/o_lsu_rvalid] [get_bd_pins swerv_wrapper_verilog/lsu_axi_rvalid]
  connect_bd_net -net intcon_wrapper_bd_0_o_lsu_wready [get_bd_pins intcon_wrapper_bd_0/o_lsu_wready] [get_bd_pins swerv_wrapper_verilog/lsu_axi_wready]
  ...
  connect_bd_net -net intcon_wrapper_bd_0_o_sb_arready [get_bd_pins intcon_wrapper_bd_0/o_sb_arready] [get_bd_pins swerv_wrapper_verilog/sb_axi_arready]
  connect_bd_net -net intcon_wrapper_bd_0_o_sb_awready [get_bd_pins intcon_wrapper_bd_0/o_sb_awready] [get_bd_pins swerv_wrapper_verilog/sb_axi_awready]
  connect_bd_net -net intcon_wrapper_bd_0_o_sb_bid [get_bd_pins intcon_wrapper_bd_0/o_sb_bid] [get_bd_pins swerv_wrapper_verilog/sb_axi_bid]
  connect_bd_net -net intcon_wrapper_bd_0_o_sb_bresp [get_bd_pins intcon_wrapper_bd_0/o_sb_bresp] [get_bd_pins swerv_wrapper_verilog/sb_axi_bresp]
  connect_bd_net -net intcon_wrapper_bd_0_o_sb_bvalid [get_bd_pins intcon_wrapper_bd_0/o_sb_bvalid] [get_bd_pins swerv_wrapper_verilog/sb_axi_bvalid]
  connect_bd_net -net intcon_wrapper_bd_0_o_sb_rdata [get_bd_pins intcon_wrapper_bd_0/o_sb_rdata] [get_bd_pins swerv_wrapper_verilog/sb_axi_rdata]
  connect_bd_net -net intcon_wrapper_bd_0_o_sb_rid [get_bd_pins intcon_wrapper_bd_0/o_sb_rid] [get_bd_pins swerv_wrapper_verilog/sb_axi_rid]
  connect_bd_net -net intcon_wrapper_bd_0_o_sb_rlast [get_bd_pins intcon_wrapper_bd_0/o_sb_rlast] [get_bd_pins swerv_wrapper_verilog/sb_axi_rlast]
  connect_bd_net -net intcon_wrapper_bd_0_o_sb_rresp [get_bd_pins intcon_wrapper_bd_0/o_sb_rresp] [get_bd_pins swerv_wrapper_verilog/sb_axi_rresp]
  connect_bd_net -net intcon_wrapper_bd_0_o_sb_rvalid [get_bd_pins intcon_wrapper_bd_0/o_sb_rvalid] [get_bd_pins swerv_wrapper_verilog/sb_axi_rvalid]
  connect_bd_net -net intcon_wrapper_bd_0_o_sb_wready [get_bd_pins intcon_wrapper_bd_0/o_sb_wready] [get_bd_pins swerv_wrapper_verilog/sb_axi_wready]
  ...
  connect_bd_net -net rst_0_1 [get_bd_ports rst_0] [get_bd_pins bootrom_wrapper_0/i_rst] [get_bd_pins gpio_wrapper_0/wb_rst_i] [get_bd_pins intcon_wrapper_bd_0/rst_ni_wrapper] [get_bd_pins swerv_wrapper_verilog/rst] [get_bd_pins syscon_wrapper_0/i_rst]
  connect_bd_net -net swerv_wrapper_verilog_0_dmi_reg_rdata [get_bd_ports dmi_reg_rdata_0] [get_bd_pins swerv_wrapper_verilog/dmi_reg_rdata]
  connect_bd_net -net swerv_wrapper_verilog_0_ifu_axi_araddr [get_bd_pins intcon_wrapper_bd_0/i_ifu_araddr] [get_bd_pins swerv_wrapper_verilog/ifu_axi_araddr]
  connect_bd_net -net swerv_wrapper_verilog_0_ifu_axi_arburst [get_bd_pins intcon_wrapper_bd_0/i_ifu_arburst] [get_bd_pins swerv_wrapper_verilog/ifu_axi_arburst]
  connect_bd_net -net swerv_wrapper_verilog_0_ifu_axi_arcache [get_bd_pins intcon_wrapper_bd_0/i_ifu_arcache] [get_bd_pins swerv_wrapper_verilog/ifu_axi_arcache]
  connect_bd_net -net swerv_wrapper_verilog_0_ifu_axi_arid [get_bd_pins intcon_wrapper_bd_0/i_ifu_arid] [get_bd_pins swerv_wrapper_verilog/ifu_axi_arid]
  connect_bd_net -net swerv_wrapper_verilog_0_ifu_axi_arlen [get_bd_pins intcon_wrapper_bd_0/i_ifu_arlen] [get_bd_pins swerv_wrapper_verilog/ifu_axi_arlen]
  connect_bd_net -net swerv_wrapper_verilog_0_ifu_axi_arlock [get_bd_pins intcon_wrapper_bd_0/i_ifu_arlock] [get_bd_pins swerv_wrapper_verilog/ifu_axi_arlock]
  connect_bd_net -net swerv_wrapper_verilog_0_ifu_axi_arprot [get_bd_pins intcon_wrapper_bd_0/i_ifu_arprot] [get_bd_pins swerv_wrapper_verilog/ifu_axi_arprot]
  connect_bd_net -net swerv_wrapper_verilog_0_ifu_axi_arqos [get_bd_pins intcon_wrapper_bd_0/i_ifu_arqos] [get_bd_pins swerv_wrapper_verilog/ifu_axi_arqos]
  connect_bd_net -net swerv_wrapper_verilog_0_ifu_axi_arregion [get_bd_pins intcon_wrapper_bd_0/i_ifu_arregion] [get_bd_pins swerv_wrapper_verilog/ifu_axi_arregion]
  connect_bd_net -net swerv_wrapper_verilog_0_ifu_axi_arsize [get_bd_pins intcon_wrapper_bd_0/i_ifu_arsize] [get_bd_pins swerv_wrapper_verilog/ifu_axi_arsize]
  connect_bd_net -net swerv_wrapper_verilog_0_ifu_axi_arvalid [get_bd_pins intcon_wrapper_bd_0/i_ifu_arvalid] [get_bd_pins swerv_wrapper_verilog/ifu_axi_arvalid]
  connect_bd_net -net swerv_wrapper_verilog_0_ifu_axi_rready [get_bd_pins intcon_wrapper_bd_0/i_ifu_rready] [get_bd_pins swerv_wrapper_verilog/ifu_axi_rready]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_araddr [get_bd_pins intcon_wrapper_bd_0/i_lsu_araddr] [get_bd_pins swerv_wrapper_verilog/lsu_axi_araddr]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_arburst [get_bd_pins intcon_wrapper_bd_0/i_lsu_arburst] [get_bd_pins swerv_wrapper_verilog/lsu_axi_arburst]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_arcache [get_bd_pins intcon_wrapper_bd_0/i_lsu_arcache] [get_bd_pins swerv_wrapper_verilog/lsu_axi_arcache]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_arid [get_bd_pins intcon_wrapper_bd_0/i_lsu_arid] [get_bd_pins swerv_wrapper_verilog/lsu_axi_arid]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_arlen [get_bd_pins intcon_wrapper_bd_0/i_lsu_arlen] [get_bd_pins swerv_wrapper_verilog/lsu_axi_arlen]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_arlock [get_bd_pins intcon_wrapper_bd_0/i_lsu_arlock] [get_bd_pins swerv_wrapper_verilog/lsu_axi_arlock]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_arprot [get_bd_pins intcon_wrapper_bd_0/i_lsu_arprot] [get_bd_pins swerv_wrapper_verilog/lsu_axi_arprot]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_arqos [get_bd_pins intcon_wrapper_bd_0/i_lsu_arqos] [get_bd_pins swerv_wrapper_verilog/lsu_axi_arqos]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_arregion [get_bd_pins intcon_wrapper_bd_0/i_lsu_arregion] [get_bd_pins swerv_wrapper_verilog/lsu_axi_arregion]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_arsize [get_bd_pins intcon_wrapper_bd_0/i_lsu_arsize] [get_bd_pins swerv_wrapper_verilog/lsu_axi_arsize]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_arvalid [get_bd_pins intcon_wrapper_bd_0/i_lsu_arvalid] [get_bd_pins swerv_wrapper_verilog/lsu_axi_arvalid]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_awaddr [get_bd_pins intcon_wrapper_bd_0/i_lsu_awaddr] [get_bd_pins swerv_wrapper_verilog/lsu_axi_awaddr]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_awburst [get_bd_pins intcon_wrapper_bd_0/i_lsu_awburst] [get_bd_pins swerv_wrapper_verilog/lsu_axi_awburst]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_awcache [get_bd_pins intcon_wrapper_bd_0/i_lsu_awcache] [get_bd_pins swerv_wrapper_verilog/lsu_axi_awcache]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_awid [get_bd_pins intcon_wrapper_bd_0/i_lsu_awid] [get_bd_pins swerv_wrapper_verilog/lsu_axi_awid]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_awlen [get_bd_pins intcon_wrapper_bd_0/i_lsu_awlen] [get_bd_pins swerv_wrapper_verilog/lsu_axi_awlen]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_awlock [get_bd_pins intcon_wrapper_bd_0/i_lsu_awlock] [get_bd_pins swerv_wrapper_verilog/lsu_axi_awlock]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_awprot [get_bd_pins intcon_wrapper_bd_0/i_lsu_awprot] [get_bd_pins swerv_wrapper_verilog/lsu_axi_awprot]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_awqos [get_bd_pins intcon_wrapper_bd_0/i_lsu_awqos] [get_bd_pins swerv_wrapper_verilog/lsu_axi_awqos]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_awregion [get_bd_pins intcon_wrapper_bd_0/i_lsu_awregion] [get_bd_pins swerv_wrapper_verilog/lsu_axi_awregion]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_awsize [get_bd_pins intcon_wrapper_bd_0/i_lsu_awsize] [get_bd_pins swerv_wrapper_verilog/lsu_axi_awsize]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_awvalid [get_bd_pins intcon_wrapper_bd_0/i_lsu_awvalid] [get_bd_pins swerv_wrapper_verilog/lsu_axi_awvalid]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_bready [get_bd_pins intcon_wrapper_bd_0/i_lsu_bready] [get_bd_pins swerv_wrapper_verilog/lsu_axi_bready]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_rready [get_bd_pins intcon_wrapper_bd_0/i_lsu_rready] [get_bd_pins swerv_wrapper_verilog/lsu_axi_rready]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_wdata [get_bd_pins intcon_wrapper_bd_0/i_lsu_wdata] [get_bd_pins swerv_wrapper_verilog/lsu_axi_wdata]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_wlast [get_bd_pins intcon_wrapper_bd_0/i_lsu_wlast] [get_bd_pins swerv_wrapper_verilog/lsu_axi_wlast]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_wstrb [get_bd_pins intcon_wrapper_bd_0/i_lsu_wstrb] [get_bd_pins swerv_wrapper_verilog/lsu_axi_wstrb]
  connect_bd_net -net swerv_wrapper_verilog_0_lsu_axi_wvalid [get_bd_pins intcon_wrapper_bd_0/i_lsu_wvalid] [get_bd_pins swerv_wrapper_verilog/lsu_axi_wvalid]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_araddr [get_bd_pins intcon_wrapper_bd_0/i_sb_araddr] [get_bd_pins swerv_wrapper_verilog/sb_axi_araddr]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_arburst [get_bd_pins intcon_wrapper_bd_0/i_sb_arburst] [get_bd_pins swerv_wrapper_verilog/sb_axi_arburst]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_arcache [get_bd_pins intcon_wrapper_bd_0/i_sb_arcache] [get_bd_pins swerv_wrapper_verilog/sb_axi_arcache]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_arid [get_bd_pins intcon_wrapper_bd_0/i_sb_arid] [get_bd_pins swerv_wrapper_verilog/sb_axi_arid]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_arlen [get_bd_pins intcon_wrapper_bd_0/i_sb_arlen] [get_bd_pins swerv_wrapper_verilog/sb_axi_arlen]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_arlock [get_bd_pins intcon_wrapper_bd_0/i_sb_arlock] [get_bd_pins swerv_wrapper_verilog/sb_axi_arlock]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_arprot [get_bd_pins intcon_wrapper_bd_0/i_sb_arprot] [get_bd_pins swerv_wrapper_verilog/sb_axi_arprot]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_arqos [get_bd_pins intcon_wrapper_bd_0/i_sb_arqos] [get_bd_pins swerv_wrapper_verilog/sb_axi_arqos]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_arregion [get_bd_pins intcon_wrapper_bd_0/i_sb_arregion] [get_bd_pins swerv_wrapper_verilog/sb_axi_arregion]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_arsize [get_bd_pins intcon_wrapper_bd_0/i_sb_arsize] [get_bd_pins swerv_wrapper_verilog/sb_axi_arsize]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_arvalid [get_bd_pins intcon_wrapper_bd_0/i_sb_arvalid] [get_bd_pins swerv_wrapper_verilog/sb_axi_arvalid]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_awaddr [get_bd_pins intcon_wrapper_bd_0/i_sb_awaddr] [get_bd_pins swerv_wrapper_verilog/sb_axi_awaddr]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_awburst [get_bd_pins intcon_wrapper_bd_0/i_sb_awburst] [get_bd_pins swerv_wrapper_verilog/sb_axi_awburst]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_awcache [get_bd_pins intcon_wrapper_bd_0/i_sb_awcache] [get_bd_pins swerv_wrapper_verilog/sb_axi_awcache]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_awid [get_bd_pins intcon_wrapper_bd_0/i_sb_awid] [get_bd_pins swerv_wrapper_verilog/sb_axi_awid]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_awlen [get_bd_pins intcon_wrapper_bd_0/i_sb_awlen] [get_bd_pins swerv_wrapper_verilog/sb_axi_awlen]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_awlock [get_bd_pins intcon_wrapper_bd_0/i_sb_awlock] [get_bd_pins swerv_wrapper_verilog/sb_axi_awlock]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_awprot [get_bd_pins intcon_wrapper_bd_0/i_sb_awprot] [get_bd_pins swerv_wrapper_verilog/sb_axi_awprot]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_awqos [get_bd_pins intcon_wrapper_bd_0/i_sb_awqos] [get_bd_pins swerv_wrapper_verilog/sb_axi_awqos]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_awregion [get_bd_pins intcon_wrapper_bd_0/i_sb_awregion] [get_bd_pins swerv_wrapper_verilog/sb_axi_awregion]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_awsize [get_bd_pins intcon_wrapper_bd_0/i_sb_awsize] [get_bd_pins swerv_wrapper_verilog/sb_axi_awsize]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_awvalid [get_bd_pins intcon_wrapper_bd_0/i_sb_awvalid] [get_bd_pins swerv_wrapper_verilog/sb_axi_awvalid]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_bready [get_bd_pins intcon_wrapper_bd_0/i_sb_bready] [get_bd_pins swerv_wrapper_verilog/sb_axi_bready]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_rready [get_bd_pins intcon_wrapper_bd_0/i_sb_rready] [get_bd_pins swerv_wrapper_verilog/sb_axi_rready]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_wdata [get_bd_pins intcon_wrapper_bd_0/i_sb_wdata] [get_bd_pins swerv_wrapper_verilog/sb_axi_wdata]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_wlast [get_bd_pins intcon_wrapper_bd_0/i_sb_wlast] [get_bd_pins swerv_wrapper_verilog/sb_axi_wlast]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_wstrb [get_bd_pins intcon_wrapper_bd_0/i_sb_wstrb] [get_bd_pins swerv_wrapper_verilog/sb_axi_wstrb]
  connect_bd_net -net swerv_wrapper_verilog_0_sb_axi_wvalid [get_bd_pins intcon_wrapper_bd_0/i_sb_wvalid] [get_bd_pins swerv_wrapper_verilog/sb_axi_wvalid]
  ...
  connect_bd_net -net syscon_wrapper_0_o_nmi_int [get_bd_pins swerv_wrapper_verilog/nmi_int] [get_bd_pins syscon_wrapper_0/o_nmi_int]
  connect_bd_net -net syscon_wrapper_0_o_nmi_vec [get_bd_pins swerv_wrapper_verilog/nmi_vec] [get_bd_pins syscon_wrapper_0/o_nmi_vec]
  connect_bd_net -net syscon_wrapper_0_o_timer_irq [get_bd_pins swerv_wrapper_verilog/timer_int] [get_bd_pins syscon_wrapper_0/o_timer_irq]

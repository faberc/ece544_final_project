...
module axi_demux_id_counters #(
  ...
  // lookup
  input wire logic [AxiIdBits-1:0] lookup_axi_id_i,
  output mst_port_select_t     lookup_mst_select_o,
  output wire logic                 lookup_mst_select_occupied_o,
  // push
  output wire logic                 full_o,
  input wire logic [AxiIdBits-1:0] push_axi_id_i,
  input  mst_port_select_t     push_mst_select_i,
  input wire logic                 push_i,
  // inject ATOPs in AR channel
  input wire logic [AxiIdBits-1:0] inject_axi_id_i,
  input wire logic                 inject_i,
  // pop
  input wire logic [AxiIdBits-1:0] pop_axi_id_i,

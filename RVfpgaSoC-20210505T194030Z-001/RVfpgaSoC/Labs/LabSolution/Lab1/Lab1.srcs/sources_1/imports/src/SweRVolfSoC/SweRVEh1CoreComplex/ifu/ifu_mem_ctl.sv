...
// memory protection
   assign ifc_region_acc_okay           =  (~(|{1'h1,1'h1,1'h1,1'h1,1'h0,1'h0,1'h0,1'h0})) |
                                           (1'h1 & (({fetch_addr_f1[31:1],1'b0} | 'h7fffffff) == ('h0 | 'h7fffffff))) |
                                           (1'h1 & (({fetch_addr_f1[31:1],1'b0} | 'h3fffffff) == ('hc0000000 | 'h3fffffff))) |
                                           (1'h1 & (({fetch_addr_f1[31:1],1'b0} | 'h1fffffff) == ('ha0000000 | 'h1fffffff))) |
                                           (1'h1 & (({fetch_addr_f1[31:1],1'b0} | 'h0fffffff) == ('h80000000 | 'h0fffffff))) |

...
#ifndef _VSWERVOLF_CORE_TB_AXI_DEMUX__PI2_H_
#define _VSWERVOLF_CORE_TB_AXI_DEMUX__PI2_H_  // guard
...
class Vswervolf_core_tb_axi_demux_id_counters__pi5;


//----------

VL_MODULE(Vswervolf_core_tb_axi_demux__pi2) {
  public:
    // CELLS
    Vswervolf_core_tb_axi_demux_id_counters__pi5* __PVT__gen_demux__DOT__i_aw_id_counter;
    Vswervolf_core_tb_axi_demux_id_counters__pi5* __PVT__gen_demux__DOT__i_ar_id_counter;
  ...
  public:
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(Vswervolf_core_tb_axi_demux__pi2);  ///< Copying not allowed
  public:
    Vswervolf_core_tb_axi_demux__pi2(const char* name = "TOP");
    ~Vswervolf_core_tb_axi_demux__pi2();
    
    // INTERNAL METHODS
    void __Vconfigure(Vswervolf_core_tb__Syms* symsp, bool first);
    void _combo__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__0__KET____DOT__i_axi_demux__22(Vswervolf_core_tb__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset() VL_ATTR_COLD;
  public:
    void _multiclk__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__0__KET____DOT__i_axi_demux__19(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _multiclk__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__0__KET____DOT__i_axi_demux__25(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _multiclk__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__1__KET____DOT__i_axi_demux__20(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _multiclk__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__1__KET____DOT__i_axi_demux__26(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _multiclk__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__2__KET____DOT__i_axi_demux__21(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _multiclk__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__2__KET____DOT__i_axi_demux__27(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _sequent__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__0__KET____DOT__i_axi_demux__10(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _sequent__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__0__KET____DOT__i_axi_demux__13(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _sequent__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__0__KET____DOT__i_axi_demux__16(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _sequent__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__1__KET____DOT__i_axi_demux__11(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _sequent__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__2__KET____DOT__i_axi_demux__12(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _settle__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__0__KET____DOT__i_axi_demux__1(Vswervolf_core_tb__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    void _settle__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__0__KET____DOT__i_axi_demux__4(Vswervolf_core_tb__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    void _settle__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__0__KET____DOT__i_axi_demux__7(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _settle__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__1__KET____DOT__i_axi_demux__5(Vswervolf_core_tb__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    void _settle__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__1__KET____DOT__i_axi_demux__8(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _settle__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__2__KET____DOT__i_axi_demux__6(Vswervolf_core_tb__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    void _settle__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_slv_port_demux__BRA__2__KET____DOT__i_axi_demux__9(Vswervolf_core_tb__Syms* __restrict vlSymsp);
  private:

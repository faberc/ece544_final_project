...
#ifndef _VSWERVOLF_CORE_TB_AXI_MUX__PI4_H_
#define _VSWERVOLF_CORE_TB_AXI_MUX__PI4_H_  // guard
...
VL_MODULE(Vswervolf_core_tb_axi_mux__pi4) {
  public:
  ...
  public:
    ...
    // CONSTRUCTORS
  private:
    VL_UNCOPYABLE(Vswervolf_core_tb_axi_mux__pi4);  ///< Copying not allowed
  public:
    Vswervolf_core_tb_axi_mux__pi4(const char* name = "TOP");
    ~Vswervolf_core_tb_axi_mux__pi4();
    
    // INTERNAL METHODS
    void __Vconfigure(Vswervolf_core_tb__Syms* symsp, bool first);
    void _combo__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_mst_port_mux__BRA__0__KET____DOT__i_axi_mux__13(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _combo__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_mst_port_mux__BRA__0__KET____DOT__i_axi_mux__5(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _combo__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_mst_port_mux__BRA__0__KET____DOT__i_axi_mux__9(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _combo__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_mst_port_mux__BRA__1__KET____DOT__i_axi_mux__14(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _combo__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_mst_port_mux__BRA__1__KET____DOT__i_axi_mux__6(Vswervolf_core_tb__Syms* __restrict vlSymsp);
  private:
    void _ctor_var_reset() VL_ATTR_COLD;
  public:
    void _sequent__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_mst_port_mux__BRA__0__KET____DOT__i_axi_mux__11(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _sequent__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_mst_port_mux__BRA__0__KET____DOT__i_axi_mux__15(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _sequent__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_mst_port_mux__BRA__0__KET____DOT__i_axi_mux__7(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _sequent__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_mst_port_mux__BRA__1__KET____DOT__i_axi_mux__12(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _sequent__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_mst_port_mux__BRA__1__KET____DOT__i_axi_mux__16(Vswervolf_core_tb__Syms* __restrict vlSymsp);
    void _settle__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_mst_port_mux__BRA__0__KET____DOT__i_axi_mux__1(Vswervolf_core_tb__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    void _settle__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_mst_port_mux__BRA__0__KET____DOT__i_axi_mux__3(Vswervolf_core_tb__Syms* __restrict vlSymsp) VL_ATTR_COLD;
    void _settle__TOP__swervolf_core_tb__swervolf__axi_intercon__DOT__axi_xbar__DOT__gen_mst_port_mux__BRA__1__KET____DOT__i_axi_mux__4(Vswervolf_core_tb__Syms* __restrict vlSymsp) VL_ATTR_COLD;
  private:
